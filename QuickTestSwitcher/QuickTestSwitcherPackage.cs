...
namespace bleistift.QuickTestSwitcher
{
    ...
    [Guid(GuidList.guidQuickTestSwitcherPkgString)]
    public sealed class QuickTestSwitcherPackage : Package
    {
        /// <summary>
        ...
        /// </summary>
        public QuickTestSwitcherPackage()
        {
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                CommandID menuCommandID = new CommandID(GuidList.guidQuickTestSwitcherCmdSet, (int)PkgCmdIDList.cmdidSwitchCommand);
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            if (doc != null)
                Switch(doc.ProjectItem.ContainingProject, doc);
        }
